...
namespace NetPdf
{
    public class Ninio
    {
        ...
        public static void CreateAtencionNinio(string filePDF, List<ProblemaList> problemasList,
             List<TipoAtencionList> planIntegralList,
             DatosAtencion datosAtencion,
             PacientList datosPac,
             List<EsoAntecedentesPadre> Antecedentes,
             List<EsoCuidadosPreventivosFechas> FechasCP,
             OrganizationDto infoEmpresaPropietaria,
             NinioCustom datosNinio,
             List<EsoCuidadosPreventivosComentarios> ComentariosCP)
        {
                ...
                cells = new List<PdfPCell>()
            {
                ...
                var problemasCronicos = problemasList.FindAll(p => p.i_Tipo == (int)Enumeratores.TipoProblema.Cronico);
                ...
                if (problemasCronicos != null && problemasCronicos.Count > 0)
                {
                    ...
                    foreach (var item in problemasCronicos)
                    {
                        ...
                        cell = new PdfPCell(new Phrase(item.d_Fecha.ToShortDateString(), fontColumnValue)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 };
                        cells.Add(cell);
                ...
                var problemasAgudos = problemasList.FindAll(p => p.i_Tipo == (int)Enumeratores.TipoProblema.Agudo);
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONTROL DE CRECIMIENTO Y DESARROLLO").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONTROL DE CRECIMIENTO Y DESARROLLO").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" :ComentariosCP.
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIÓN DE ESTIMULACIÓN TEMPRANA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIÓN DE ESTIMULACIÓN TEMPRANA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1  },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(y => y.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(y => y.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "ANEMIA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "ANEMIA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "PARASITOSIS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "PARASITOSIS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "VISITA").FirstOrDefault().Hijos.Where(y => y.Nombre == "VISITA FAMILIAR INTEGRAL").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "VISITA").FirstOrDefault().Hijos.Where(y => y.Nombre == "VISITA FAMILIAR INTEGRAL").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1  },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1  },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Count == 0 ? "" : ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "OTROS").FirstOrDefault().Hijos.Where(y => y.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "OTROS").FirstOrDefault().Hijos.Where(y => y.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = alto_Celda_1 },
